...
```solution
// Traditional function expression converted to arrow function
...
// Arrow function and arguments object (alternative using rest parameters)
const showArrowArguments = (...args) => {
